...
public class LineaFacturaJDialog extends javax.swing.JDialog {
    
    Crud crud;
    private Factura factura;
    DefaultTableModel dtmLineasFactura;
    
    public LineaFacturaJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public LineaFacturaJDialog(java.awt.Frame parent, boolean modal, Factura factura) {
        super(parent, modal);
        initComponents();
    ...
    private void initConfiguracion() {
        crud = new Crud();
        dtmLineasFactura = (DefaultTableModel) jtLineasFactura.getModel();
        ...
        this.jtfNumeroFactura.setText(Herramientas.dfNumEntero.format(this.factura.getNumFactura()));
    ...
    private void rellenarTablaLineasFactura() {
        for (Articulo a : (Set<Articulo>) factura.getListaArticulos()) {
            dtmLineasFactura.addRow(new Object[]{this.factura.getNumFactura(), a.getCodArticulo()});
        }
    }
    
    private void actualizarTabla() {
        Herramientas.limpiarTabla(dtmLineasFactura);
        Set setArticulos = ((Factura) crud.read(Factura.class, factura.getNumFactura())).getListaArticulos();
        for (Articulo a : (Set<Articulo>) setArticulos) {
            dtmLineasFactura.addRow(new Object[]{this.factura.getNumFactura(), a.getCodArticulo()});
        }
    }
    ...
    private void jbCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCrearActionPerformed
        Articulo articulos = (Articulo) crud.read(Articulo.class, jtfCodigoArticulo.getText());
        if (articulos != null) {
            factura.addArticulo(articulos);
            crud.update(factura);
            actualizarTabla();
    ...
    private void jbModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbModificarActionPerformed
        /*if (!jtfNumeroFactura.getText().isEmpty()) {
            try {
                Articulo articulos = new Articulo(jtfNumeroFactura.getText(), familias, jtfCodigoArticulo.getText(), Herramientas.stringABigDecimalPrecio(jtfPrecio.getText()));
    ...
    private void jbBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBorrarActionPerformed
        /*if (!jtfNumeroFactura.getText().isEmpty()) {
            String error = crud.delete(new Articulo(jtfNumeroFactura.getText()));
            if (!error.isEmpty()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LineaFacturaJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LineaFacturaJDialog dialog = new LineaFacturaJDialog(new javax.swing.JFrame(), true);
